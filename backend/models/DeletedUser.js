...
const DeletedUser = sequelize.define("deleted_user", {
  id: {
  ...
  //   validate: {
  //     isBase64(value) {
  //       if (value && !/^data:image\/(png|jpeg|jpg|gif);base64,/.test(value)) {
  //         throw new Error('Photo must be a valid base64 encoded image');
  //       }
  //     }
  //   }
  // },
