...
const AttendanceDashboard = () => {
  ...
  const fetchOverallAttendance = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:3001/api/overall-attendance?UserId=${user.sin_number}`);
  ...
  const fetchDailyAttendance = useCallback(async () => {
    try {
      const user = JSON.parse(sessionStorage.getItem('user'));
      const response = await axios.get(`http://localhost:3001/api/daily-attendance?UserId=${user.sin_number}&startDate=${format(startDate, 'yyyy-MM-dd')}&endDate=${format(endDate, 'yyyy-MM-dd')}`);
      if (response.data.success) {
  ...
  const fetchWeeklyAttendance = useCallback(async () => {
    try {
      const user = JSON.parse(sessionStorage.getItem('user'));
      const response = await axios.get(`http://localhost:3001/api/weekly-attendance?UserId=${user.sin_number}&year=${selectedYear}&month=${selectedMonth}&week=${selectedWeek}`);
      if (response.data.success) {
  ...
  const fetchMonthlyAttendance = useCallback(async () => {
    try {
      const user = JSON.parse(sessionStorage.getItem('user'));
      const response = await axios.get(`http://localhost:3001/api/monthly-attendance?UserId=${user.sin_number}&year=${selectedYear}`);
      if (response.data.success) {
