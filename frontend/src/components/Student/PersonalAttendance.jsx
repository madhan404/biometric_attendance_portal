...
import { green, red, orange, blue, purple, pink, grey, yellow } from '@mui/material/colors';
...
const SummaryCards = ({ overallData, theme, viewMode }) => {
  ...
  const dailyCards = [
    ...
    {
      title: 'Internship Days',
      value: overallData?.internshipDays,
      subtitle: 'Industry training days',
      gradient: `linear-gradient(135deg, ${pink[300]} 0%, ${pink[500]} 100%)`
    },
    {
  ...
  // For weekly and monthly views, show only the overall percentage card
  const summaryCards = [
    {
      title: 'Overall Attendance',
      value: `${overallData?.overallPercentage}%`,
  ...
  const cardsToShow = viewMode === 'daily' ? dailyCards : summaryCards;
...
const DailyView = ({ 
  ...
  const pieData = useMemo(() => [
    ...
    { 
      name: 'Internship', 
      value: dailyData.filter(d => d.internshipStatus).length,
      color: pink[700]
    }
  ], [dailyData]);
  ...
  const weeklySummaryData = [
    {
      ...
      Internship: weeklyDisplayData.statistics.internshipDays,
                ...
                <PieChart>
                  <Pie
                    data={[
                      ...
                      { name: 'Internship', value: weeklyDisplayData.statistics.internshipDays, color: pink[500] },
        ...
        <Box sx={{ height: 300 }}>
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar dataKey="Internship" name="Internship" fill={pink[500]} />
                    ...
                    <TableCell>
                      <Chip
                        ...
                        color={
                          day.status === 'Present' ? 'success' :
                          day.status === 'Absent' ? 'error' :
                          day.status === 'Late' ? 'warning' : 'default'
                        }
                      />
                    </TableCell>
          ...
          <Table sx={{ minWidth: isMobile ? 650 : 750 }}>
            <TableHead>
              <TableRow sx={{ backgroundColor: theme.palette.grey[100] }}>
                ...
                <TableCell sx={{ fontWeight: 'bold', color: theme.palette.primary.dark }} align="center">Internship</TableCell>
                ...
                >
                  ...
                  <TableCell align="center">
                    <Box sx={{ 
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 'bold', color: pink[900] }}>
                        {month.statistics.internshipDays}
                      </Typography>
                    </Box>
                  </TableCell>
                  <TableCell align="center">
...
const AttendanceDashboard = () => {
  ...
  return (
    <Box sx={{ display: 'flex', mt: -4, height: '100vh' }}>
      <CssBaseline />
