      ...
      {selectedRequest && (
        <>
          ...
          <DialogActions sx={{ p: 2 }}>
            {selectedRequest.approvals.class_advisor_approval === "approved" &&
        ...
        <>
          <Stack spacing={2}>
            {paginatedRequests.map((request) => {
              ...
              const overallStatus = request.approvals.hod_approval || "pending";
                  ...
                  >
                    ...
                    <AccordionDetails sx={{ pt: 0, pb: 2, px: 2 }}>
                      <Grid container spacing={2} sx={{ mb: 2 }}>
                        <Grid item xs={12} md={6}>
                          <Typography variant="subtitle2">
                            {request.year} Year • {request.department}
                          </Typography>
                          <CompactInfoItem
                            icon={<Description />}
                            label="Reason"
