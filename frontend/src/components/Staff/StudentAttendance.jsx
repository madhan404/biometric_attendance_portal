...
const StudentAttendanceDashboard = () => {
  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      ...
      switch (viewMode) {
        case 'daily':
          response = await axios(`${API_BASE_URL}/classadvisor/daily-attendance`, {
            params: {
        ...
        case 'weekly':
          response = await axios(`${API_BASE_URL}/classadvisor/weekly-attendance`, {
            params: {
        ...
        case 'monthly':
          response = await axios(`${API_BASE_URL}/classadvisor/monthly-attendance`, {
            params: {
              year: selectedYear,
              month: format(new Date(selectedYear, selectedMonth, 1), 'MMMM').toLowerCase(),
              sin_number: classAdvisorInfo.sin_number
  ...
  const fetchStudentAttendance = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      const response = await axios(`${API_BASE_URL}/classadvisor/student-attendance`, {
        params: {
          sin_number: classAdvisorInfo.sin_number,
  ...
  const AttendanceTableView = () => {
    ...
    useEffect(() => {
      const fetchStudentData = async () => {
        ...
        try {
          setLoading(true);
          const response = await axios.get(`${API_BASE_URL}/classadvisor/student-attendance`, {
            params: {
              sin_number: classAdvisorInfo.sin_number,
              date: format(selectedDate, 'yyyy-MM-dd')
            }
