...
import HodLeaveApplication from "../components/Hod/HodLeaveApplication"
import RequestTable from "../components/Hod/RequestTable";
import StudentAttendance from "../components/Hod/StudentAttendance";
import HodLeaveApprovalStatus from "../components/Hod/HodLeaveApprovalStatus";
import DataPage from "../components/Hod/DataPage";
import PersonalAttendance from "../components/Hod/PersonalAttendance";
    ...
    <>
      <Box sx={{ display: "flex" }}>
            ...
            <List>
              ...
              <Collapse in={attendanceOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <ListItem button sx={{ pl: 4 }} onClick={() => setSelectedContent("studentAttendance")}>
              ...
              <ListItem button onClick={() => setSelectedContent("HodLeaveApplication")}>
                <ListItemText primary="Hod Leave Request" />
              </ListItem>
              <ListItem button onClick={() => setSelectedContent("HodleaveApprovalStatus")}>
                <ListItemText primary="Hod Leave Approval Status" />
              </ListItem>
            </List>
            <Divider />
          </Box>
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          {selectedContent === "HodLeaveApplication" && <HodLeaveApplication />}
          {selectedContent === "HodleaveApprovalStatus" && <HodLeaveApprovalStatus />}
